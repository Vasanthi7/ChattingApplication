...
Chatbucket.service('fileUpload', ['$http','$location', function ($http,$scope,$location) {
	this.uploadFileToUrl = function(file, uploadUrl,name,password,address,dob,emailId,contactNo){
	       var fd = new FormData();
...
Chatbucket.controller('registerController', ['$scope', 'fileUpload', function($scope,fileUpload){
    $scope.register = function(){
       ...
       fileUpload.uploadFileToUrl(file, uploadUrl,name,password,address,dob,emailId,contactNo);
