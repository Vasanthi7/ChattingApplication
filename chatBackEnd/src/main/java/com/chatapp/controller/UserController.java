...
public void registerUser(@RequestParam("file") MultipartFile file,@RequestParam("name") String name,@RequestParam("password") String password,@RequestParam("address") String address,@RequestParam("dob") String dob,@RequestParam("emailId") String emailId,@RequestParam("contactNo") String contactNo)
{
	...
	Path path=Paths.get("D://chatFrontEnd//WebContent//images//"+name+".jpg");
	if(file!=null)
	{
		try {
